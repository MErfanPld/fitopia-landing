    ...
    <section className="relative py-28 lg:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] rounded-full bg-[#FF6A00]/15 blur-[120px]"
        />
      </div>
      ...
      <div className="container-narrow section-padding relative z-10 text-center">
        ...
        >
          همین حالا اپلیکیشن را دانلود کنید یا باشگاه خود را در فیتوپیا ثبت کنید.
        </motion.p>
